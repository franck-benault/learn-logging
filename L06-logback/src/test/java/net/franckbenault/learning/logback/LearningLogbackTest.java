package net.franckbenault.learning.logback;
...
public class LearningLogbackTest {
	
	
	private static final Logger LOGGER =  LoggerFactory.getLogger(LearningLogbackTest.class);
